...
NUM_WORKERS = 0
LEARNING_RATE = 0.001  # MODIFIED: V7 - AdamW
WEIGHT_DECAY = 1e-4  # MODIFIED: V7 - AdamW
...
class DeeperWiderNet(nn.Module):  # MODIFIED: V4 - Deeper and Wider
    ...
    def make_layers(self):
        ...
        feature_layers += [nn.Conv2d(1, 8, kernel_size=5, stride=1, padding=2, bias=True)]  # MODIFIED: V8 - Data Augmentation
        feature_layers += [nn.BatchNorm2d(8)]  # MODIFIED: V6 - Batch Normalization
        ...
        feature_layers += [nn.BatchNorm2d(16)]  # MODIFIED: V6 - Batch Normalization
        feature_layers += [nn.ReLU(inplace=True)]  # MODIFIED: V5 - ReLU and Kaiming Initialization
        ...
        classifier_layers += [nn.BatchNorm1d(120)]  # MODIFIED: V6 - Batch Normalization
        ...
        classifier_layers += [nn.BatchNorm1d(84)]  # MODIFIED: V6 - Batch Normalization
        classifier_layers += [nn.ReLU(inplace=True)]  # MODIFIED: V5 - ReLU and Kaiming Initialization
...
def main():
    ...
    ### MODIFIED: V8 - Data Augmentation (BEGIN) ###
    ...
    ### MODIFIED: V8 - Data Augmentation (END) ###
    ...
    optimizer = optim.AdamW(model.parameters(), lr=LEARNING_RATE, weight_decay=WEIGHT_DECAY, amsgrad=True)  # MODIFIED: V7 - AdamW
